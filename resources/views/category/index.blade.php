            ...
            <div class="row">
                        ...
                        <div class="modal fade" id="addNew" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-top" role="document">
                                <div class="modal-content">
                                    ...
                                    <form class="formLoad" action="{{ route('category.store') }}" id="formadd" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-lg-12 mb-3">
                                                    <label class="form-label">{{ __('messages.category_name') }}</label> <label class="text-danger">*</label>
                                                    <input class="form-control" type="text" name="category" placeholder="Input {{ __('messages.category_name') }}.." required>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="col-4">
                    <div class="text-center">
                        <h4 class="text-bold">{{ __('messages.category') }}</h4>
                    </div>
                </div>
                <div class="col-4"></div>
            </div>
            ...
            <table class="table table-bordered dt-responsive nowrap w-100" id="ssTable">
                <thead class="table-light">
                    <tr>
                        ...
                        <th class="align-middle text-center">{{ __('messages.category_name') }}</th>
